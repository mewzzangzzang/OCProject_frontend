    ...
    return (
      <div className="all mt-4">
        <div className="mapChart">
          <iframe
            src="https://public.tableau.com/views/_16969935994890/1_1?:language=ko-KR&:display_count=n&:origin=viz_share_link?:showVizHome=no?:embed=true"
            width="1500"
            height="600"
            title="우럭"
          />
